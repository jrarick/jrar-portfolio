...
![A presenter showing a dashboard with multiple types of graphs and metrics](/blog-assets/openai-dashboard.png)
...
<div className="w-full h-64 bg-gradient-to-br from-pink-700 via-purple-700 to-blue-700" />
